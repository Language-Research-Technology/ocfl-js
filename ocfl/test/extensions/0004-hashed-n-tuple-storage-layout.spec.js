...
describe("HashedNTupleStorageLayout class", function () {
  ...
  it("can use default config", function () {
    let layout = new HashedNTupleStorageLayout();
    let cases = [
  ...
  it("can use custom config", function () {
    let layout = new HashedNTupleStorageLayout({digestAlgorithm: "md5", tupleSize: 2, numberOfTuples: 15, shortObjectRoot: true });
    let cases = [
  ...
  it("can use custom config, edge case", function () {
    let layout = new HashedNTupleStorageLayout({digestAlgorithm: "sha256", tupleSize: 0, numberOfTuples: 0, shortObjectRoot: false });
    let cases = [
