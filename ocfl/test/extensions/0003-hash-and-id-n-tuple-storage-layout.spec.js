...
describe("HashAndIdNTupleStorageLayout class", function () {
  ...
  it("can map valid id with default config", function() {
    let layout = HashAndIdNTupleStorageLayout.create();
  ...
  it("can map valid id with tupleSize=2 and numberOfTuples=0", function() {
    let layout = HashAndIdNTupleStorageLayout.create({digestAlgorithm: "md5", tupleSize: 2, numberOfTuples: 15});
  ...
  it("can map valid id with tupleSize=0 and numberOfTuples=0", function() {
    let layout = HashAndIdNTupleStorageLayout.create({digestAlgorithm: "sha256", tupleSize: 0, numberOfTuples: 0});
